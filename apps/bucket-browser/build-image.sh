#!/usr/bin/env bash
set -euo pipefail
# build-image.sh — Build the Bucket Browser image and push it to the local k3d
# registry. Self-contained (run from anywhere); builds from this folder's Dockerfile.
#
# Usage:
